...
// The script  represents the waypoint nodes. It includes a variable that stores a list of connections for the waypoint node.
// The code also displays the position of the waypoint node and it's connections.
//It draws a line where a connection is found
public class VisGraphWaypointManager : MonoBehaviour
{
    // Allow you to set the waypoint text colour.
    [SerializeField]
    private enum waypointTextColour
    {
        Blue,
        Cyan,
        Yellow
