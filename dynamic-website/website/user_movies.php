...
$mysqli = mysqli_connect("localhost", "2108418", "Leslieblantina@1", "db2108418");
        ...
        $sql1 = "INSERT INTO Best(Film_name, Genre,Director,Lead_Actor, Year, Score, BADGE, User_permit)";
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			$Genre = $_REQUEST['Genre'];
			$Film_name = $_REQUEST['name'];
			$Director = $_REQUEST['Director'];
			$Lead_Actor = $_REQUEST['Lname'];
			$Year = $_REQUEST['Year'];
			...
			$sql1.= " VALUES ('". $Film_name ."' , '". $Genre ."' , '". $Director ."', '". $Lead_Actor ."', '". $Year ."', '". $Score ."', '". $Rank . "', '". $User . "');";
			
			 $res1 = mysqli_query($mysqli, $sql1);
			 if(!$res1){
				 echo "Error: " . $sql . "<br>" . mysqli_error($mysqli);
			 }else{
				 echo "You have successfully submitted a movie, we will review your choice and get back to you soon";
			 }
		}
?>
...
<div class="wrapper">
        <h2>Submit Film</h2>
        <p>Please fill this form to add your movie.</p>
