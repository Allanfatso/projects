...
$mysqli = mysqli_connect("localhost", "2108418", "Leslieblantina@1", "db2108418");
        ...
        $sql1 = "DELETE FROM Best";
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			$movie = $_REQUEST['name'];
			$User = $_SESSION["username"];
			
			
			$sql1.= " WHERE (Film_name = '".$movie."') AND (User_permit = '".$User."');";
			
			 $res1 = mysqli_query($mysqli, $sql1);
			 if(!$res1){
				 echo "Error: " . $sql . "<br>" . mysqli_error($mysqli). " You are not authorized to make changes to this movie.";
			 }else{
				 echo "You have successfully deleted your movie review";
			 }
		}
?>
<!DOCTYPE html>
...
<div class="wrapper">
        ...
        <p>Please fill this to delete your movie.</p>
