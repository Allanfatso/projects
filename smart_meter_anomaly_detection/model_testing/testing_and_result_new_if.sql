...
-- insert 100 synthetic anomalies.
...
CREATE TABLE test_with_synthetic_new AS
SELECT
  reading_id,
  date_time,
  std_or_tou,
...
CREATE or replace VIEW synthetic_anomalies_unseen_raw_new AS
SELECT 
    date_time,
